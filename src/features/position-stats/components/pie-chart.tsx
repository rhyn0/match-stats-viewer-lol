...
export interface PieChartProps<T extends BasePositionDataT> {
    className?: string;
...
export default function PieChart<DataT extends BasePositionDataT>({
    className,
    chartConfig = {},
    data,
    dataKey,
    ...
    return (
        ...
        >
            <RechartPieChart accessibilityLayer>
                <ChartTooltip
                    content={
                        <ChartTooltipContent
                            labelKey="position"
